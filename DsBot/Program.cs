...
builder.Services.AddSingleton<IBotCommand, Test>();
builder.Services.AddSingleton<IBotCommand, Balance>();
builder.Services.AddSingleton<IBotCommand, AdminCommands>();
